...
@section('content')
  ...
  <?php if (count($imgs) != 1) : ?>
    <a href="#myModal-add-more-img" id="add-more-img-btn" role="button" class="btn btn-info pull-right" data-toggle="modal">Add an image</a>
  <?php endif; ?>
   ...
   <div class="modal hide" id="myModal-add-more-img" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              ...
              <div class="modal-header">
                ...
                <div class="modal-footer">
                      ...
                      {{ Form::open_for_files( action('admin.news@add_img') ) }}

                          {{ Form::token() }}

                          {{ Form::hidden('news_id', URI::segment(4)) }}
  ...
  <ul class="thumbnails">
      @foreach($imgs as $img)  
          <li class="span4">
              <a href="{{ asset('uploads/news/' . $img->name ) }}" class="thumbnail">
                <img src="{{ asset('uploads/news/' . $img->name ) }}" width="290">
              </a>
              ...
              <div class="modal-header">
                ...
                <div class="modal-footer">
                  ...
                  {{ Form::open( action('admin.news@delete_img', array($img->id)) ) }}
